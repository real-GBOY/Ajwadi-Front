...
export const FormInput = forwardRef<HTMLInputElement, FormInputProps>(
  ({ label, error, required, dir = 'rtl', className = '', ...props }, ref) => {
    const inputClasses = `w-full px-4 py-2.5 border rounded-xl text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-primary transition-all shadow-sm ${
      error
    ...
    return (
      <div>
        ...
        <input ref={ref} className={inputClasses} dir={dir} {...props} />
        {error && (
